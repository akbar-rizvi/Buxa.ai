...
_a = user;
user.registerUser = (userData) => __awaiter(void 0, void 0, void 0, function* () {
...
user.loginUser = (email, password) => __awaiter(void 0, void 0, void 0, function* () {
...
user.refreshToken = (refreshToken) => __awaiter(void 0, void 0, void 0, function* () {
    try {
